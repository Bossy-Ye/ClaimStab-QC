...
figures:
	PYTHONPATH=. ./venv/bin/python -m claimstab.scripts.make_paper_figures --input-dir output/paper/artifact/large/maxcut_ranking --also-calibration output/paper/artifact/calibration/maxcut_ranking --output-dir output/paper/artifact/figures/main
...
reproduce-paper:
	PYTHONPATH=. ./venv/bin/python -m claimstab.scripts.reproduce_paper --out-root output/paper/artifact --backend-engine basic
