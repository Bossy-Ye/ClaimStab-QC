...
This directory stores short paper-facing notes that explain how to read the
curated figures, tables, and results.

These notes are designed to be reused when drafting:
- results prose,
- captions,
...
These notes are intentionally short and stable.
Long derivations should stay in:
- source scripts,
- generated outputs,
- or appendix-facing audit documents.
