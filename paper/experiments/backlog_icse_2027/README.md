...
1. Do not start a task before its backlog file exists.
...
1. `01_REPO_CONVERGENCE`
2. `02_E1_METRIC_VS_CLAIM`
3. `03_E2_BASELINE_COMPARISON`
4. `05_E4_EXACT_MOS`
5. `04_E3_SCOPE_ROBUSTNESS`
6. `12_RQ4_PRACTICALITY`
7. `06_E5_CROSS_FAMILY`
8. `07_E6_REAL_HARDWARE`
9. `08_FIGURES_AND_TABLES`
10. `09_ICSE_PACK_AND_ARTIFACT`
11. `10_PAPER_FRAMING`
